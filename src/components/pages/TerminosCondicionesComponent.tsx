  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Los presentes Términos y Condiciones regulan el uso de la tienda online <strong>ImprimeArte</strong>, 
            ubicada en la dirección web www.imprimarte.com, propiedad de ImprimeArte S.L., con domicilio social 
          ...
          <p>
            El uso de nuestra web implica la aceptación plena y sin reservas de todas y cada una de las 
            disposiciones incluidas en estos Términos y Condiciones. Si no está de acuerdo con alguna de 
            estas condiciones, debe abstenerse de utilizar nuestros servicios.
          </p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            ImprimeArte es una plataforma de comercio electrónico especializada en la personalización 
            e impresión de productos bajo demanda. Nuestros servicios incluyen:
          </p>
          <ul className="list-disc ml-6 space-y-2">
            <li><strong>Personalización de productos:</strong> Textil, vajilla, tecnología, hogar, regalos corporativos y más</li>
            <li><strong>Servicios de diseño gráfico:</strong> Creación y adaptación de diseños profesionales</li>
            <li><strong>Impresión con múltiples técnicas:</strong> DTF, sublimación, grabado láser, UV DTF, impresión 3D</li>
            <li><strong>Venta de productos estándar:</strong> Productos sin personalizar listos para enviar</li>
          </ul>
          <p>
            Todos los productos se fabrican bajo demanda tras la confirmación del pedido y la aprobación 
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Para realizar pedidos en ImprimeArte, no es obligatorio crear una cuenta, aunque es recomendable 
            para facilitar la gestión de pedidos y futuras compras.
          </p>
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            <strong>1. Selección y Personalización:</strong> El cliente selecciona el producto y realiza 
            la personalización mediante nuestra herramienta online o enviando su archivo de diseño.
          </p>
          <p>
            <strong>2. Revisión del Pedido:</strong> Antes de proceder al pago, el cliente debe revisar 
            cuidadosamente todos los detalles del pedido: producto, diseño, cantidad, precio y datos de envío.
          </p>
          <p>
            <strong>3. Pago:</strong> Una vez confirmado el pedido, el cliente procede al pago mediante 
            los métodos disponibles. El cargo se realizará en el momento de la confirmación.
          </p>
          <p>
          ...
          <p>
            <strong>5. Producción:</strong> Una vez aprobado el diseño, iniciamos la producción. 
            El plazo de fabricación es de 3-5 días hábiles según el producto.
          </p>
          <p>
            <strong>6. Envío:</strong> Tras la fabricación, el producto se envía a la dirección indicada. 
            Recibirás un número de seguimiento por email.
          </p>
          <p className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded">
            <strong>Importante:</strong> Una vez aprobada la prueba digital e iniciada la producción, 
            no será posible realizar cambios ni cancelar el pedido.
          </p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            Todos los precios mostrados en nuestra web están expresados en Euros (€) e incluyen el IVA 
          ...
          <ul className="list-disc ml-6 space-y-2">
            <li>Modificar los precios en cualquier momento, aunque respetaremos siempre el precio confirmado en tu pedido</li>
          ...
          <p>
            ...
            confirmar el pedido. Ofrecemos envío gratuito en pedidos superiores a 50€ en España peninsular.
          </p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            <strong>Contenido de la Web:</strong> Todo el contenido de www.imprimarte.com, incluyendo 
            textos, imágenes, logotipos, diseños, código fuente y cualquier otro material, está protegido 
            por derechos de propiedad intelectual y pertenece a ImprimeArte o sus licenciantes.
          </p>
          <p>
            <strong>Diseños del Cliente:</strong> El cliente garantiza que:
          </p>
          <ul className="list-disc ml-6 space-y-2">
            <li>Es el propietario legítimo o tiene autorización para usar los diseños que proporciona</li>
          ...
          <p className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
            ...
            diseño que pueda infringir derechos de terceros o contenga material inapropiado, ofensivo 
            o ilegal. No nos hacemos responsables del uso indebido de diseños por parte del cliente.
          </p>
          <p>
            <strong>Uso Comercial:</strong> Si el cliente planea usar los productos con fines comerciales 
            (reventa, merchandising, etc.), debe asegurarse de contar con todas las licencias necesarias.
          </p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc ml-6 space-y-2">
            <li><strong>Estándar:</strong> Gratuito en pedidos +50€, 5.99€ en pedidos inferiores</li>
            <li><strong>Express (24-48h):</strong> 9.99€</li>
            <li><strong>Urgente (24h):</strong> 14.99€</li>
          </ul>
          <p>
            Los plazos de entrega son orientativos y comienzan a contar desde la aprobación del diseño 
            y finalización de la producción. No incluyen fines de semana ni festivos.
          </p>
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            ImprimeArte no se hace responsable de:
          </p>
          <ul className="list-disc ml-6 space-y-2">
            ...
            <li>Infracciones de derechos de propiedad intelectual en diseños proporcionados por el cliente</li>
            <li>Fallos técnicos ajenos a nuestro control (caídas de servidor, problemas de conexión, etc.)</li>
          </ul>
          <p>
            Nuestra responsabilidad máxima en cualquier caso estará limitada al importe pagado por el 
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>
            Para más información, consulta nuestra <a href="/politica-privacidad" className="text-cyan-600 font-bold hover:underline">Política de Privacidad</a> completa.
          </p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>
            Te recomendamos revisar periódicamente esta página para estar al tanto de posibles cambios. 
            El uso continuado de nuestros servicios tras la publicación de modificaciones constituye 
            tu aceptación de las mismas.
          </p>
          <p>
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>
            ...
            intentarán resolver amistosamente cualquier controversia antes de acudir a los tribunales.
          </p>
          <p>
            Los consumidores pueden acudir a la plataforma europea de resolución de litigios en línea: 
            <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-cyan-600 font-bold hover:underline ml-1">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Conoce nuestra empresa y valores
            </p>
          </a>
        </div>
      </div>
