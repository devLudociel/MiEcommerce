    ...
    return (
      <div className="bg-gradient-to-r from-cyan-50 to-magenta-50 rounded-xl p-4 border-2 border-cyan-200">
        <div className="flex items-center justify-between">
          ...
          <p className="text-xs text-gray-500 max-w-[150px]">Disponible para usar en esta compra</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-200 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-cyan-500 to-magenta-500 p-6 text-white">
        ...
        <p className="text-sm opacity-80 mt-2">Ganas 5% de cashback en cada compra</p>
      </div>
        ...
        <div className="p-6">
          ...
          {transactions.length === 0 ? (
            <div className="text-center py-8">
              <svg
                className="mx-auto w-16 h-16 text-gray-300 mb-3"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <p className="text-sm text-gray-400 mt-1">
                Realiza tu primera compra para ganar cashback
              </p>
            </div>
          ) : (
