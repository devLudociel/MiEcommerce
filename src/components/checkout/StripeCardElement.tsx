    ...
    <div className="space-y-2">
      ...
      <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-sm text-blue-900">
          ...
          <p className="text-blue-700 mt-1">
            Tus datos de tarjeta están protegidos con cifrado de nivel bancario.
      ...
      <div className="flex items-center justify-center gap-4 pt-2 opacity-60">
        ...
        <svg className="h-6" viewBox="0 0 50 32">
          <path fill="#00579F" d="M46.177 29.87H3.823C1.707 29.87 0 28.163 0 26.047V5.953C0 3.837 1.707 2.13 3.823 2.13h42.354C48.293 2.13 50 3.837 50 5.953v20.094c0 2.116-1.707 3.823-3.823 3.823z"/>
        </svg>
      </div>
    </div>
  );
