...
const CartDropdown = memo(function CartDropdown() {
  ...
  const handleDecrease = useCallback(
    (id: string, variantId: number | undefined, currentQty: number) => {
  ...
  return (
    <div className="cart-dropdown absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 z-50">
            ...
            <div className="flex-1">
              {bundleDiscounts.appliedDiscounts.map((discount, idx) => (
                <div key={idx} className="text-xs font-medium">
                  {discount.bundleName}:{' '}
                  <span className="text-green-600">-€{discount.savedAmount.toFixed(2)}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="border-t p-3">
        ...
        <div className="space-y-1 mb-2">
            ...
            <>
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-500 line-through">
                  €{bundleDiscounts.originalTotal.toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-green-600">Descuento pack:</span>
                <span className="font-semibold text-green-600">
                  -€{bundleDiscounts.totalDiscount.toFixed(2)}
                </span>
              </div>
            </>
          )}
          <div className="flex justify-between text-sm">
            ...
            <span className="font-bold text-cyan-700">
              €{bundleDiscounts.finalTotal.toFixed(2)}
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <a
            href="/cart"
            className="flex-1 px-3 py-2 text-sm text-center rounded border hover:bg-gray-50"
          >
            Ver carrito
          </a>
          <a
                ...
                <div
                  ...
                  onMouseLeave={(e) => {
                    ...
                    if (
                      ...
                      !relatedTarget.closest('[data-mega-menu]')
                    ) {
                      setActiveMenu(null);
                    }
                  }}
