...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    ...
    >
          ...
          <nav className="nav">
            ...
            >
              ...
              >
                ...
                <span className="text-sm hidden xl:inline">Mis favoritos</span>
              </a>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm hidden xl:block">Mi cuenta</span>
                </button>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm hidden xl:block">Cesta</span>
                  <CartBadge />
                </button>
        ...
        <div className="container">
          ...
          >
            ...
            >
              ...
              <div
                className="flex items-center"
                style={{ marginLeft: 'auto', gap: 'var(--spacing-3)' }}
              >
                <a
                  href="/ofertas"
      ...
      {/* Banner promocional */}
      <div
        className="bg-white text-white text-center relative overflow-hidden"
