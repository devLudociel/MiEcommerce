  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <a
          href="/admin/descuentos-paquete"
          className="p-4 bg-gradient-to-br from-amber-500 to-orange-500 border-2 border-amber-400 rounded-xl hover:shadow-xl transition-all text-center group relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 bg-yellow-400 text-xs font-bold px-2 py-0.5 rounded-bl-lg text-gray-900">
            NUEVO
          </div>
          <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">🎁</div>
          <div className="text-sm font-semibold text-white">3x2 y Packs</div>
        </a>
        <a
        ...
        <a
          href="/admin/notificaciones-stock"
          className="p-4 bg-gradient-to-br from-amber-500 to-yellow-500 border-2 border-amber-400 rounded-xl hover:shadow-xl transition-all text-center group relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 bg-yellow-400 text-xs font-bold px-2 py-0.5 rounded-bl-lg text-gray-900">
            NUEVO
          </div>
          <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">🔔</div>
          <div className="text-sm font-semibold text-white">Avisos Stock</div>
        </a>
        <a
          href="/admin/soporte"
          className="p-4 bg-gradient-to-br from-blue-500 to-cyan-500 border-2 border-blue-400 rounded-xl hover:shadow-xl transition-all text-center group relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 bg-yellow-400 text-xs font-bold px-2 py-0.5 rounded-bl-lg text-gray-900">
            NUEVO
          </div>
          <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">💬</div>
          <div className="text-sm font-semibold text-white">Soporte</div>
        </a>
        <a
          href="/admin/envios"
          className="p-4 bg-gradient-to-br from-orange-500 to-red-500 border-2 border-orange-400 rounded-xl hover:shadow-xl transition-all text-center group relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 bg-yellow-400 text-xs font-bold px-2 py-0.5 rounded-bl-lg text-gray-900">
            NUEVO
          </div>
        ...
        <a
          ...
          className="p-4 bg-gradient-to-br from-pink-500 to-purple-600 border-2 border-pink-400 rounded-xl hover:shadow-xl transition-all text-center group relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 bg-yellow-400 text-xs font-bold px-2 py-0.5 rounded-bl-lg text-gray-900">
            NUEVO
          </div>
