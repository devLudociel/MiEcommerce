...
export default function FilterPanel({
  ...
  const [priceRange, setPriceRange] = useState(currentFilters?.priceRange || { min: 0, max: 200 });
  ...
  const [sortBy, setSortBy] = useState<FilterOptions['sortBy']>(currentFilters?.sortBy || 'newest');
