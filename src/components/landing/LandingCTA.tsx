...
function WhatsAppCTA({ data, slug }: LandingCTAProps) {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="inline-flex items-center gap-3 px-10 py-5 text-lg font-bold rounded-xl bg-green-500 text-white hover:bg-green-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
    >
...
function LinkCTA({ data, slug }: LandingCTAProps) {
  ...
  return (
    <a
      href={data.target}
      onClick={handleClick}
      className="inline-flex items-center gap-3 px-10 py-5 text-lg font-bold rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-white hover:from-cyan-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
    >
      {data.buttonText}
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
      ...
      <button
        ...
        className="w-full px-8 py-4 text-lg font-bold rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-white hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
      >
