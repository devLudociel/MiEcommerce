...
import { getProductApprovedReviews } from '../../lib/reviews';
...
export default function ProductDetail({ id, slug }: Props) {
  ...
  useEffect(() => {
    ...
    // Load review stats (reseñas aprobadas del producto)
    (async () => {
      try {
        const productReviews = await getProductApprovedReviews(uiProduct.id);
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="flex items-center gap-4 mb-6">
                  {reviewStats.totalReviews > 0 ? (
                    <a href="#resenas" className="flex items-center gap-2 hover:opacity-80">
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            key={i}
                    ...
                    <a href="#resenas" className="text-sm text-cyan-600 hover:underline">
