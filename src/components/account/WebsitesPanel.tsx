  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="btn btn-primary">+ Nueva Web</button>
      </div>
        ...
        {websites.map((website) => (
          <div key={website.id} className="card p-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-sm text-gray-500">{website.status}</span>
            </div>

            <div className="grid grid-cols-2 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
              <div>
                <p className="text-sm text-gray-500">Vistas totales</p>
                <p className="text-2xl font-bold text-gray-900">{website.views.toLocaleString()}</p>
              </div>
              <div>
