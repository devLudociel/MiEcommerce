    ...
    },
    {
      ...
      config: {
        ...
        options: [
          ...
          { value: 'custom', label: 'Medidas personalizadas', priceModifier: 2, description: 'Te contactaremos para confirmar las medidas' }
        ]
      },
      priceModifier: 0,
      order: 2
  ...
  fields: [
    ...
    },
    {
      ...
      config: {
        layout: 'vertical',
        options: [
          { value: 'paper_matte', label: 'Papel Mate', description: 'Acabado natural', priceModifier: 0 },
          { value: 'paper_glossy', label: 'Papel Brillo', description: 'Colores vibrantes', priceModifier: 0.1 },
          { value: 'vinyl', label: 'Vinilo', description: 'Resistente al agua', priceModifier: 0.3 },
          { value: 'transparent', label: 'Transparente', description: 'Efecto cristal', priceModifier: 0.4 }
        ]
      },
      priceModifier: 0,
      order: 3
