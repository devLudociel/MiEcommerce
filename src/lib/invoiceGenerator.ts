    ...
    content: [
      ...
      },
      {
        stack: [
          ...
          {
            text: `${order.shippingInfo.zipCode} ${order.shippingInfo.city}, ${order.shippingInfo.state}`,
            ...
            ...order.items.map((item) => [
              {
                stack: [
                  ...
                  item.variantName
                    ? { text: `Variante: ${item.variantName}`, style: 'itemVariant' }
                    : {},
            ...
            stack: [
              ...
              },
              {
                columns: [
                  ...
                  {
                    text: order.shipping === 0 ? 'GRATIS' : `€${order.shipping.toFixed(2)}`,
                    alignment: 'right',
                    style: 'totalValue',
                  },
                ],
