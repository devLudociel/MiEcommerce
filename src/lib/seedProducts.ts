...
const initialProducts: Omit<FirebaseProduct, 'id' | 'createdAt' | 'updatedAt'>[] = [
  {
    ...
    description: 'Camiseta de algodón 100% personalizable con tu diseño. Calidad premium y acabado profesional.',
    category: 'textil',
    basePrice: 8.00,
    images: [
  ...
  },
  {
    ...
    description: 'Sudadera de alta calidad con interior de felpa. Perfecta para estampados y bordados.',
    category: 'textil',
    basePrice: 25.00,
    images: [
      'https://via.placeholder.com/400x400/f59e0b/white?text=Sudadera+Premium'
    ],
    customizable: true,
    customizationOptions: [
      {
  ...
  },
  {
    ...
    basePrice: 15.00,
    images: [
      'https://via.placeholder.com/400x400/10b981/white?text=Cuadro+Personalizado'
    ],
    customizable: true,
    customizationOptions: [
      {
